...
![Go](https://github.com/defool/go-json/workflows/Go/badge.svg)
[![GoDoc](https://godoc.org/github.com/defool/go-json?status.svg)](https://pkg.go.dev/github.com/defool/go-json?tab=doc)
[![codecov](https://codecov.io/gh/defool/go-json/branch/master/graph/badge.svg)](https://codecov.io/gh/defool/go-json)
...
If you have the API you need, please submit your issue [here](https://github.com/defool/go-json/issues).

# Features

- Drop-in replacement of `encoding/json`
- Fast ( See [Benchmark section](https://github.com/defool/go-json#benchmarks) )
...
```
go get github.com/defool/go-json
```

# How to use

Replace import statement from `encoding/json` to `github.com/defool/go-json`

```
-import "encoding/json"
+import "github.com/defool/go-json"
```
...
[go-json-fuzz](https://github.com/defool/go-json-fuzz) is the repository for fuzzing tests.
If you run the test in this repository and find a bug, please commit to corpus to go-json-fuzz and report the issue to [go-json](https://github.com/defool/go-json/issues).
...
The technique for working with `*reflect.rtype` directly from `go-json` is implemented at [rtype.go](https://github.com/defool/go-json/blob/master/internal/runtime/rtype.go)
...
If you want to know more, please refer to the implementation [here](https://github.com/defool/go-json/blob/master/internal/runtime/type.go#L36-L100)
